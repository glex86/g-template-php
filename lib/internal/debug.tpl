...
<SCRIPT language=javascript>
    ...
    {foreach key=key item=vars from=$_debug_keys}
        _gTemplate_console.document.write("<tr bgcolor={if $key % 2}#eeeeee{else}#fafafa{/if}>");
        _gTemplate_console.document.write("<td valign=top><tt><font color=blue>{ldelim}${$_debug_keys[$key]}{rdelim}</font></tt></td>");
    ...
    {foreach key=key item=config_vars from=$_debug_config_keys}
        _gTemplate_console.document.write("<tr bgcolor={if $key % 2}#eeeeee{else}#fafafa{/if}>");
        _gTemplate_console.document.write("<td valign=top><tt><font color=maroon>{ldelim}#{$_debug_config_keys[$key]}#{rdelim}</font></tt></td>");
