...
/**
 * gTemplate {html_select_time} function plugin
 *
 * Type:     function<br>
 ...
 */
function tpl_function_html_select_time($params, &$gTpl) {
    ...
    foreach ($params as $_key => $_value) {
        switch ($_key) {
            ...
            default:
                $gTpl->trigger_error("[html_select_time] unknown parameter $_key", E_USER_WARNING);
        }
    }
