...
/**
 * gTemplate {html_select_date} plugin
 *
 * Type:     function<br>
        ...
        switch ($_key) {
            ...
            default:
                if(!is_array($_value)) {
                    ...
                    $gTpl->trigger_error("html_select_date: extra attribute '$_key' cannot be an array", E_USER_NOTICE);
                }
                break;
        }
    }
